...
$app->get('/users',function (Request $request, Response $response, $parameters){
    $result = \Httpful\Request::get('https://jsonplaceholder.typicode.com/todos')->send();
     $data = $result->body;
    return view($response,'table',compact('data'));
});

$app->get('/local_api',function (Request $request, Response $response, $parameters){
     $data = '[
  {
    "userId": 1,
    "id": 1,
